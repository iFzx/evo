 ...
 **•** Bot Developer : <@542787046142640138>
...
client.on("message", message => {
 if (message.content === "*invite") {
  const embed = new Discord.RichEmbed()
      .setColor("#030303")
      .setFooter('© Evo Bot :heart: جميع الحقوق محفوظة 2019 لــبوت')
...
client.on("message", message => {
 if (message.content === "*support") {
  const embed = new Discord.RichEmbed()
      ...
      .setColor("#030303")
      .setFooter('© Evo Bot :heart: جميع الحقوق محفوظة 2018 لــبوت')  
