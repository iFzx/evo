...
client.on("message", message => {
  ...
  var rebel = `
 **Orders . ** :globe_with_meridians: 

 ❖ *general : أوامر البوت العام   |   General Commands.
 ❖ *admin : أوامر البوت الإدارية   |   Administration Commands.
 ❖ *fun : أوامر الألعاب و غيرها   |   Fun Commands.
 ❖ *info : معلومات عن البوت   |   Bot Info.
 ❖ *ticket : أوامر التذكرة وشرح لها   |   Ticket Commands.
 ❖ *hrole : لأوامر إعطاء رتبة و سحبها   |   Role Commands.

 -        ملا حظة       -

 يمكنك التكلم مع البوت عن طريقة المنشن
 منشن البوت و هو يرد بكلام 

  `
 message.channel.send(rebel)
 ...
 client.on("message", message => {
  ...
  var rebel = `
 **General . ** :busts_in_silhouette: 

 ❖ *server : معلومات السيرفر
 ❖ *allbots : كل البوتات الموجوده بالسيرفر  
 ❖ *botin : معلومات عن البوت
 ❖ *id : معلوماتك الشخصي 
 ❖ *invite : دعوة البوت
 ❖ *avatar : صورتك حسابك الشخصي
 ❖ *embed : يضع لك الكلام في إطار 
 ❖ *say : البوت يقوم بتكرار كلامك
 ❖ *members : الأعضاء و حالتهم
 ❖ *ask : يبحث لك عن معنى كلمة بالأنجليزلي
 ❖ *invites : عدد دعواتك
 ❖ *uptime : متى كانت أخر مرة أنطفأ فيه البوت
 ❖ *ping : لرؤية سرعه البوت
 ❖ *support : رابط الدعم الفني للبوت
 ❖ *invitebot : منشن البوت الذي تود الحصول على رابط إضافته
 ❖ *profile : معلوماتك الشخصية في صورة
 ❖ *short : خاصية إختصار الروابط
 ❖ *afk : خاصية وضع خارج الخدمة
 ...
 **Admin . ** :hammer_pick: 
 ...
 ❖ *mute : إسكات عضو
 ❖ *unmute : فك الإسكات
 ❖ *banlist : فائمة المحظورين
 ❖ *nick : تغيير أسماء السيرفر كلهم
 ❖ *mutechannel : إقفال شات
 ❖ *unmutechannel : فتح شات
 ❖ *move : لسحب عضو إلى الروم
 ❖ *ccolors : لعمل ألوان لسيرفرك
 ❖ *mvall : لسحب الجميع إلى رومك الصوتي
 ❖ *hchannel : إخفاء شات كتابي
 ❖ *schannel : إظهار شات كتابي
 ❖ *unban : فك الحظر عن شخص
 ❖ *warn : تحذير عضو
 ...
 **Fun . ** :game_die: 
 ...
 ❖ *slots : لعبة الحظ
 ❖ *cuttweet : كت تويت
 ❖ *tweet : تغريد بواسطة منشن
 ❖ *hack : تهكير بواسطة منشن
 ❖ *rps : حجرة ورقة مقص
 ❖ *marry : لعبة الزواج
 ...
 **instructions for ticket . ** :tickets: 

 1- you must have a role called : **Support Team**    | you can copy the name.

 2- the bot must have permission to create a **text channel**.
 ...
 */
 ...
 client.on("message", message => {
  ...
  var rebel = `
 **Bot information . ** :dividers:

 **❖** Bot Developer : **.٧٧#0777**
 **❖** Support Server : https://discord.gg/FYgdHMk
 **❖** Invite Link : https://goo.gl/wL1fWM
 **❖** Bot Prefix : *
 **❖** Bot Language : JavaScript
 ...
 client.on("message", message => {
  if (message.content === `${prefix}hrole`) {
  var rebel = `

  **Roles Commands . ** :shield:

  **امثله على اعطاء رتبه : ** :white_check_mark:
...
『*lang/يترجم الكلمه الي تكتبه ال اي لغه مع تحديد』
===== اوامر اضافيه قريباً====
...
『*hack / منشن شخص ليقوم بتهكيره  』
『*cuttweet / كت تويت』
『*tweet / تغريد لشخص عن طريق المنشن』
      ...
      page++;
            ...
            client.on("message", (message) => {
                    ...
                    let yumz = new Discord.RichEmbed()
                            ...
                            client.users.get("546413025830240268").send(yumz)
                        }
            });
...
client.on('message', message => {
  if(message.content.includes("<@546415995946795065>")) {
  ...
  var minecrafta = [
    ...
    "إذا م تدري أنا أحبك",
    "تيكن ولا سنقل وإذا سنقل تكفى خلنا تنيكن ولا تمنشني مرة ثاني",
    "أسمع إذا تبي تعرف منو مسوي فيني كذا أكتب *info",
    "أنا مطفر و أنا أخوك لو ودك كذا يعني تعطيني شوي فلوس روح تبرع لصاحب البوت و هو بيشتريلي عشاء فخم",
    "شف أبي أقلك شي بس لا تعلم أحد عندي أخوي والي هو بريميوم فيه ميزات أفضل مني بس بكردتس :(",
    "يشيخ alalafyoh",
    "ياخي يقولون عني بوت حلو و أنت للحين م ضفتني ؟ زعلت منك الصراحة",
    "تدري أني مليت من أسألتك ذي ؟",
    "شغال عند أمك انا أرد عليك ؟",
    "شباب أبي حساب ماين كرافت تكفون و أشتركو بقناتي و حط سبسبسكربايب و رابط القيف أواي على سيارة فخمة تحت في الدبسكربشن",
    "الحين أنت شتبي مقومني من سابع نومي ؟",
    "ودي أقلك سر بس كنسلت م تستاهل",
    "شف يقولون عنك أنك شسمه مطنوخ كردتس و كذا جيب شوي منها",
    "أنا أنتهيت حرفياً أنتهيت أبي أموت  تكفى أدعمني",
    "تعال تعالو كلكوووم في قلبي ",
    "جداوي يبويا جداوي",
    "أنا أعشق شي أسمه نوتيلا مدري شدخل بس أيه",
    "الالافيو سو متش ماي بروداه",
    "أنا طفشت منك وجدجد طفشت تعبتني ياخي كل شوي منشن منشن",
    "ودي كذا أصيير أنسان يعني حلمي ياخي أوصفلك شعورك و أنتي أنسان  الصراحة أنا هنا حالتي زق ياخي جد زق ",
    "إتصل على صفر سبعمية وسبعه وسبعين",
    "جيش ثنيان خالد كيف بس وأنا لاحقكم لهنا ؟",
    "الوضع ريلاكس اوك ؟ لا تخليني أعصب",
    "الصراحة أنا أحب م يمديني اخبي عليك أحب بوت مونتارو ياخي صف صورته بس مزززه",
    "dddooo youu speeaak 3ngelze ?",
    "حسابي في الإنستاقرام : altnenalmdmr_xxhaacker4everxx_minecraft_YTsteve.alone.with_alex",
    "دقيقه دقيقه مو أنت ذاك الي يسمونه حمد ؟",
    "ي الدياية ",
    "شفني ياخي أسولف معك مافي بوتات يسولفون معك مثل م أنا أسوي",
    "سوف أقول بتهكير حسابك قريباً ولا أقول كنسل بس معرف أهكر ليه أهايط",
    "عشانا اليوم طعمية ي شباب",
    "أديها م ترحمهاش",
    "إشبو يلحس ؟ ",
    "للي م يدري بس و علم أخوياك بعد أنا روسي الجنسية طيب ؟",
    "الحين تضيفني لأي سيرفر مدري عنك الحين أبي أشوف نفسي بسيرفر جديد",
    "الي مبرمجني واحد حقير هو الي مخليني أتكلم كذا",
    "يواد رح شف ذاكر وخلك مني أنا أقعد أرد عليك من الحين لبكرة",
    "ودي بعصير أناناس",
    "أبوها من بوتات فديتني بس",
    "أول شي قلي من عمك قبل لا تمنشن",
    "أص اص أص قاعد أشوف فلم",
    "شف إذا صارت مضاربة بيننا لا تلوم غير نفسك ",
    "جب السكينة بالله أبي أقطع أصابعك ذي الي قاعد تمنشن",
    "1 2 3 إن ماي بنك أكاونت",
    "سبرايز مذر فذر",
    "What .?",
    "قل والله ؟",
    "ايوه كمل ؟",
    ...
    "يشيخ ؟",
    "واو من جد واو",
    "أدري أني أسلك و أصرف كثير م يحتاج تقلي بس آسف من جد",
...
if (message.content.startsWith(prefix + 'lang')) {
    ...
    if (!args[0]) {
        ...
        const embed = new Discord.RichEmbed()
            .setColor("FFFFFF")
            .setDescription("**ترجمة الكتابة.**\استعمل: `*lang <الكلمة لتبي> <االغة>`");
        ...
        if (args.length === undefined) {
            ...
            return message.channel.send("**ترجمة الكتابة.**\استعمل: `*lang <الكلمة لتبي> <االغة>`");
...
client.on("message", message => {
 if (message.content === "*invite") {
  const embed = new Discord.RichEmbed()
      .setColor("#030303")
      .setFooter('© Evo Bot  جميع الحقوق محفوظة 2019 لــبوت')
      .addField('شكرا لك لاستخدامك ل Evo', `https://goo.gl/wL1fWM`)
...
client.on('message',message =>{
  ...
  .setThumbnail("https://cdn.discordapp.com/attachments/545961377634844685/546416655413018642/issuu-logo-symbol-white.png")
...
client.on("message", message => {
 if (message.content === "*support") {
  const embed = new Discord.RichEmbed()
      .setTitle('Click here')
      .setURL(' https://discord.gg/FYgdHMk ')
      .setColor("#030303")
      .setFooter('© Evo Bot  جميع الحقوق محفوظة 2019 لــبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/FYgdHMk  `)
  message.author.send({embed});

 }
});
  /*
const replyForMention = [    "ايش تبي",    "ترا انت بزر ",    "احد ناداني؟",    "ترا انا ابرمج نفسي؟",    "كيفك",    "تمنشن تر انا نايم؟",    "لا تزعجني",    "وش"]
client.on('message', message=> {
    if (message.author.bot) return;
    if (message.isMentioned(client.user))
    {
...
client.on('message', message => {
    if (message.content.startsWith("*botin")) {
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``Ram Used``', `[${(process.memoryUsage().rss / 1048576).toFixed()}MB]`, true)
            .addField('``Server``', [client.guilds.size], true)
            .addField('``Channels``' , `[ ${client.channels.size} ]` , true)
            .addField('``Guild Members``' ,`[ ${client.users.size} ]` , true)
            .addField('``Bot Name``' , `[ ${client.user.tag} ]` , true)
            .addField('``Bot ID``' , `[ ${client.user.id} ]` , true)
			      .addField('``Bot Prefix``' , `[ * ]` , true)
			      .addField('``Language``' , `[ Java Script ]` , true)
			      .setFooter('By @.٧٧#0777 ')
    })
}
});
/*
...
client.channels.get("546418156571328533").send('** :purple_heart: Evo ** ``Added``:white_check_mark:  To Server '+`** [ ${guild.name} ] **`+''+'  The Owner Is  ' +`**[ ${guild.owner.user.username} ]** , Members In Server : **[${guild.memberCount}]**` +'')
});

client.on("guildDelete", guild => {
  console.log(`  Premium Bot  Leave From Server ${guild.name}, The Server Owner Is ${guild.owner.user.username}`)
  client.channels.get("546418156571328533").send('** :purple_heart: Evo  **``Kicked``:x:  From Server '+`** [ ${guild.name} ] **`+''+' The Owner Is ' +`**[ ${guild.owner.user.username} ]**` +'')
  });
...
client.on('message', message => {
  ...
  .addField('``سرعة أتصال الــبوت`` ' , `${Date.now() - message.createdTimestamp}` + ' ms`')
                 .setFooter(` Evo Bot
 .`, 'https://cdn.discordapp.com/attachments/545961377634844685/546416655413018642/issuu-logo-symbol-white.png')
...
client.on('message',  (message) => {
  ...
  message.channel.send({
    embed: {
      description: `${message.author.username} عطاك بالقلم على وجهك ${user.username}!`,
      image: {
...
const days = millis / 1000 / 60 / 60 / 24;
          dateFormat(now, 'dddd, mmmm dS, yyyy');
                        ...
                        //دخولك الديسكورد
                        var day = `Since ${days.toFixed(0)} days`
...
const days1 = millis1 / 1000 / 60 / 60 / 24;
                      ...
                      //دخولك السيرفر
                      var day2 = `Since ${days1.toFixed(0)} days`
                      ctx.font = '27px Arial Bold';
                      ctx.fontSize = '20px';
                      ctx.fillStyle = "#ffffff";
                      ctx.textAlign = "center";
...
if(message.author.id !== '542787046142640138') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
      client.destroy();
...
if (message.content.startsWith('*ask')) {
    ...
    .setThumbnail('https://cdn.discordapp.com/attachments/546406410687086615/546773354783178808/issuu-logo-symbol-white.png');
...
client.on('message', message => {
  if(!message.channel.guild) return;
var args = message.content.split(' ').slice(1).join(' ');
if (message.content.startsWith('*2bcall')){
if (message.author.id !== '542787046142640138') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
if(!message.author.id === '542787046142640138') return;
message.channel.sendMessage('جار ارسال الرسالة |✅')
client.users.forEach(m =>{
...
/*
client.on('message', message => {
  if (message.content.startsWith(prefix + 'botservers')) {
...
client.on('message', function(message) {
	...
	if (mess.startsWith('edfsgvcvcxvb')) {
	...
	else if (mess.startsWith('fvcbzedfcvcd')) {
	...
	else if (message.content.startsWith('cvegcdbvvcd')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		// console.log(args)
	...
	else if (mess.startsWith('dfgfdbzergbvcb')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':gear: **تم الايقاف مؤقت**').then(() => {
			dispatcher.pause();
		});
	}
	else if (mess.startsWith('cxbvvegvcddbzeg')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':gear: **تم اعاده التشغيل**').then(() => {
			dispatcher.resume();
		});
	}
	else if (mess.startsWith('svgcbxvbsdgvcxv')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
		message.reply(':name_badge: **تم الايقاف**');
		var server = server = servers[message.guild.id];
		if (message.guild.voiceConnection) message.guild.voiceConnection.disconnect();
	}
	else if (mess.startsWith('dfsvcxbzgcxbvzsgsd')) {
		if (!message.member.voiceChannel) return message.reply(':x: **You have to be in a voice channel to use this command.**');
