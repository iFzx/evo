 ...
 **Orders . ** :globe_with_meridians: 
 ...
 ❖ *general : أوامر البوت العام
 ❖ *admin : أوامر البوت الإدارية
 ❖ *fun : أوامر الألعاب و غيرها
 ❖ *info : معلومات عن البوت
 ❖ *ticket : أوامر التذكرة وشرح لها
 ❖ *hrole : لأوامر إعطاء رتبة و سحبها
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``Evo Bot اسمي هوا📇``' , `[ ${client.user.tag} ]` , true)
