...
client.on('ready', () => {
  ...
  console.log(`Channels : [ " ${client.channels.size} " ]`);
   client.user.setActivity("Myself | *help",{type: 'WATCHING'})
...
*/
      ...
      client.on('message' , ReBeL => {
        ...
        if(ReBeL.content.startsWith(prefix + "dcolors")) {
          if (!ReBel.member.hasPermission('MANAGE_ROLES')) return ra3d.channel.sendMessage('`**⚠ | `[MANAGE_ROLES]` لا يوجد لديك صلاحية**'); 
